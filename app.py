...
app.layout = html.Div([
    ...
    html.H3(children='For all other impacts, the less you renew, the better !!!', style={"color":"Tomato"}),
    html.Div([
        dcc.Graph(id='year_graph', style={'display': 'inline-block'}),
        dcc.Graph(id='cumul_graph', style={'display': 'inline-block'})
    ]), 
    html.P('manufacturing cost is divided by the hadware lifetime.'),
    html.P('Energy efficiency gain is based on Green500 progress.')  
])
